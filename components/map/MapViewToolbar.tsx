...
export function MapViewToolbar({
  ...
  return (
    <>
      <div className="pointer-events-auto absolute top-3 right-3 z-[25] flex items-stretch gap-1.5 rounded-lg bg-white/98 p-1 shadow-md ring-1 ring-slate-200/90">
        {showDepartmentInfo && (
        ...
        <div className="flex overflow-hidden rounded-md border border-slate-200">
          ...
          <button
            ...
            className={`border-l border-slate-200 px-3 py-1.5 text-xs font-medium ${mapType === 'satellite' ? 'bg-slate-200 text-slate-900' : 'bg-white text-slate-600 hover:bg-slate-50'
              }`}
          >
